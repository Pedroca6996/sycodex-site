...
// Sons (usar qualquer .wav no mesmo diretório ou comentar se não tiver)
...
function moveBall() {
  ...
  if (ballX < 0) { player2Score++; checkWin(); resetBall(); }
  if (ballX + ballSize > canvas.width) { player1Score++; checkWin(); resetBall(); }
}
